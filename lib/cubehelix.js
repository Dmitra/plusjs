...
var self = function() {
  return d3.scale.linear()
      ...
      .interpolate(self.interpolateCubehelix);
};

self.interpolateCubehelix = interpolateCubehelix(1);
self.interpolateCubehelix.gamma = interpolateCubehelix;

function interpolateCubehelix(γ) {
  return function(a, b) {
    a = d3.hsl(a);
    b = d3.hsl(b);
